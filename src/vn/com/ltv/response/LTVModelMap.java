 ...
 */
public class LTVModelMap extends LinkedHashMap<String, Object> {

	/** serialVersionUID */
	private static final long serialVersionUID = 7909550160716963969L;
	 ...
	 */
//	public LTVModelMap(String attributeName, Object attributeValue) {
...
//	}
	 ...
	 */
//	public LTVModelMap(Object attributeValue) {
...
//	}
	 ...
	 */
//	public LTVModelMap addAttribute(String attributeName, Object attributeValue) {
...
//	}
	 ...
	 */
//	public LTVModelMap addAttribute(Object attributeValue) {
...
//	}
	 ...
	 * @see #addAttribute(Object)
	 */
//	public LTVModelMap addAllAttributes(Collection<?> attributeValues) {
...
//	}
	 ...
	 * @see #addAttribute(String, Object)
	 */
	public LTVModelMap addAllAttributes(Map<String, ?> attributes) {
		if (attributes != null) {
			putAll(attributes);
		}
		return this;
	 ...
	 * replaced).
	 */
	public LTVModelMap mergeAttributes(Map<String, ?> attributes) {
		if (attributes != null) {
